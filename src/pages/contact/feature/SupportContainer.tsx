    ...
    <>
      <Flex {...supportWrapperStyles}>
        <Flex {...supportContainerStyles}>
          <Box {...supportBoxWrapperStyles}>
            <Text>
              Vi tar även emot donationer. Det går bra med Swish men om ni vill
              donera på andra sätt kan ni höra av er till oss. Alla donationer
              går oavkortat in i organisationen igen i form av redskap som
              behövs för vårt ändamål.
            </Text>
          </Box>
